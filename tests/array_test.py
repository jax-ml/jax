...
class ShardingTest(jtu.JaxTestCase):
  ...
  def test_pmap_sharding_hash_eq(self):
    ...
    if config.pmap_shmap_merge.value:
      # TODO(dsuo): Is this true? There's named_sharding.check_pspec, but that
      # appears to be caching the sharding, not a device indices map.
      self.skipTest(
