...
ADVANCED_INDEXING_TESTS = [
    ...
    (
        ...
        [
            ...
            IndexSpec(
                shape=(3, 4, 5), indexer=onp.array([[0, 2, 0, 1], [-1, -2, 1, 0]])
            ),
        ],
    ),
    (
        ...
        [
            ...
            IndexSpec(
                shape=(3, 4, 5),
                indexer=[onp.array([0, 2, 0, 1]), onp.array([-1, 0, -1, 2])],
            ),
        ],
    ),
    (
    ...
    (
        ...
        [
            ...
            IndexSpec(
                shape=(3, 4, 5), indexer=[[[0], [-1]], onp.array([[2, 3, 0, 3]])]
            ),
        ],
    ),
]
...
ADVANCED_INDEXING_TESTS_NO_REPEATS = [
    ...
    (
        ...
        [
            ...
            IndexSpec(
                shape=(4, 5, 6),
                indexer=[onp.array([0, 2, 1, 3]), onp.array([-1, 0, -2, 1])],
            ),
        ],
    ),
    (
        ...
        [
            ...
            IndexSpec(
                shape=(4, 5, 6),
                indexer=[onp.array([[0, 2, -1, 1]]), onp.array([-1, 0, -2, 2])],
            ),
        ],
    ),
    (
...
MIXED_ADVANCED_INDEXING_TESTS_NO_REPEATS = [
    (
        ...
        [
            ...
            IndexSpec(
                shape=(3, 4, 5), indexer=(Ellipsis, onp.array([0, 2]), slice(None))
            ),
            IndexSpec(
                shape=(3, 4, 5),
                indexer=(Ellipsis, onp.array([[0, 2], [1, 3]]), slice(None)),
            ),
        ],
    ),
    (
        ...
        [
            IndexSpec(
                shape=(3, 4, 5),
                indexer=(Ellipsis, onp.array([0, 2]), onp.array([-1, 2])),
            ),
            IndexSpec(
                shape=(3, 4, 5),
                indexer=(onp.array([0, 2]), Ellipsis, onp.array([-1, 2])),
            ),
            IndexSpec(
                shape=(3, 4, 5),
                indexer=(onp.array([0, 2]), onp.array([-1, 2]), Ellipsis),
            ),
            IndexSpec(
                shape=(3, 4, 5),
                indexer=(onp.array([0, 2]), onp.array([-1, 2]), slice(1, 3)),
            ),
            IndexSpec(
                shape=(3, 4, 5),
                indexer=(onp.array([0, 2]), slice(1, 3), onp.array([-1, 2])),
            ),
            IndexSpec(
                shape=(3, 4, 5),
                indexer=(
    ...
    (
        ...
        [
            IndexSpec(
                shape=(3, 4, 5), indexer=[onp.array([0, 2]), None, onp.array([-1, 2])]
            ),
            IndexSpec(
                shape=(3, 4, 5),
                indexer=(onp.array([0, 2]), None, None, onp.array([-1, 2])),
            ),
            IndexSpec(
                shape=(3, 4, 5),
                indexer=(Ellipsis, onp.array([0, 2]), None, None, onp.array([-1, 2])),
            ),
        ],
    ),
    (
...
MIXED_ADVANCED_INDEXING_TESTS = MIXED_ADVANCED_INDEXING_TESTS_NO_REPEATS + [
    (
        ...
        [
            IndexSpec(
                shape=(3, 4, 5),
                indexer=(Ellipsis, onp.array([[0, 2], [1, 1]]), slice(None)),
            )
        ],
    ),
    (
...
class IndexingTest(jtu.JaxTestCase):
    ...
    @parameterized.named_parameters(
        ...
        for name, index_specs in [
            ...
            (
                ...
                [
                    IndexSpec(
                        shape=(3, 3), indexer=[onp.array([0, 1]), onp.array([1, 2])]
                    ),
                    IndexSpec(
                        shape=(3, 4, 5),
                        indexer=[onp.array([0, 2, 0, 1]), onp.array([-1, 0, -1, 2])],
    ...
    def testMixedAdvancedIntegerIndexing(self, shape, dtype, rng, indexer):
        ...
        substitutes = [
            (i, e) for i, e in enumerate(indexer) if not isinstance(e, onp.ndarray)
        ]
...
class IndexedUpdateTest(jtu.JaxTestCase):
    ...
    def testStaticIndexing(
        self, shape, dtype, update_shape, update_dtype, rng, indexer, op
    ):
    ...
    def testStaticIndexingGrads(
        ...
        check_grads(jax_fn, (x, y), 2, rtol=1e-3, atol=1e-3, eps=1.0)
