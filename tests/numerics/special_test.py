...
class SpecialTest(jtu.JaxTestCase):
  ...
  def test_bessel_i0e(self, dtype):
    bounds = [
        (["cpu"], {f16: 1, f32: 7}),
        (["gpu"], {f32: 8, f64: 2}),
        (tpu_devices, {f32: 8}),
  ...
  @parameterized.named_parameters(*DTYPE_PARAMS)
  def test_bessel_i1e(self, dtype):
    bounds = [
  ...
  @parameterized.named_parameters(*DTYPE_PARAMS)
  def test_digamma(self, dtype):
    bounds = [
        (["cpu"], {bf16: 18446744073709551615, f16: 18446744073709551615, f32: 18446744073709551615}),
  ...
  @parameterized.named_parameters(*DTYPE_PARAMS)
  def test_erf_inv(self, dtype):
    bounds = [
        (["cpu"], {bf16: 1, f16: 1}),
        (["gpu"], {bf16: 1, f16: 1}),
        (tpu_devices, {bf16: 1, f16: 1}),
    ]
    util.check_unary_precision(
