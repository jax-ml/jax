...
class NumpySignaturesTest(jtu.JaxTestCase):
  ...
  def testWrappedSignaturesMatch(self):
    ...
    _UFUNC_OPTIONS = ['out', 'where', 'casting', 'order', 'dtype', 'subok', 'signature']

    unsupported_params = {
      'abs': _UFUNC_OPTIONS,
      'absolute': _UFUNC_OPTIONS,
      'acos': _UFUNC_OPTIONS,
      'acosh': _UFUNC_OPTIONS,
      'add': _UFUNC_OPTIONS + ['x1', 'x2'],
      'arange': ['start_or_stop', 'like'],
      'arccos': _UFUNC_OPTIONS,
      'arccosh': _UFUNC_OPTIONS,
      'arcsin': _UFUNC_OPTIONS,
      'arcsinh': _UFUNC_OPTIONS,
      'arctan': _UFUNC_OPTIONS,
      'arctan2': _UFUNC_OPTIONS,
      'arctanh': _UFUNC_OPTIONS,
      'argpartition': ['kind', 'order'],
      'array': ['subok', 'ndmax', 'like'],
      'asarray': ['like'],
      'asin': _UFUNC_OPTIONS,
      'asinh': _UFUNC_OPTIONS,
      'atan': _UFUNC_OPTIONS,
      'atan2': _UFUNC_OPTIONS,
      'atanh': _UFUNC_OPTIONS,
      'bitwise_and': _UFUNC_OPTIONS + ['x1', 'x2'],
      'bitwise_count': _UFUNC_OPTIONS,
      'bitwise_invert': _UFUNC_OPTIONS,
      'bitwise_left_shift': _UFUNC_OPTIONS,
      'bitwise_not': _UFUNC_OPTIONS,
      'bitwise_or': _UFUNC_OPTIONS + ['x1', 'x2'],
      'bitwise_right_shift': _UFUNC_OPTIONS,
      'bitwise_xor': _UFUNC_OPTIONS + ['x1', 'x2'],
      'broadcast_to': ['subok'],
      'cbrt': _UFUNC_OPTIONS,
      'ceil': _UFUNC_OPTIONS,
      'clip': ['kwargs', 'out'],
      ...
      'conj': _UFUNC_OPTIONS,
      'conjugate': _UFUNC_OPTIONS,
      'copy': ['subok'],
      'copysign': _UFUNC_OPTIONS,
      'corrcoef': ['ddof', 'bias'],
      'cos': _UFUNC_OPTIONS,
      'cosh': _UFUNC_OPTIONS,
      'cumulative_prod': ['out'],
      'cumulative_sum': ['out'],
      'deg2rad': _UFUNC_OPTIONS,
      'degrees': _UFUNC_OPTIONS,
      'divide': _UFUNC_OPTIONS,
      'divmod': _UFUNC_OPTIONS,
      'dot': ['out'],
      'einsum': ['kwargs'],
      'einsum_path': ['einsum_call'],
      'empty': ['order', 'like'],
      'empty_like': ['subok', 'order'],
      'equal': _UFUNC_OPTIONS,
      'exp': _UFUNC_OPTIONS,
      'exp2': _UFUNC_OPTIONS,
      'expm1': _UFUNC_OPTIONS,
      'eye': ['order', 'like'],
      'fabs': _UFUNC_OPTIONS,
      'float_power': _UFUNC_OPTIONS,
      'floor': _UFUNC_OPTIONS,
      'floor_divide': _UFUNC_OPTIONS,
      'fmax': _UFUNC_OPTIONS,
      'fmin': _UFUNC_OPTIONS,
      'fmod': _UFUNC_OPTIONS,
      'frexp': _UFUNC_OPTIONS,
      'frombuffer': ['like'],
      'fromfunction': ['like'],
      'frompyfunc': ['kwargs'],
      'full': ['order', 'like'],
      ...
      'gcd': _UFUNC_OPTIONS,
      'greater': _UFUNC_OPTIONS,
      'greater_equal': _UFUNC_OPTIONS,
      'heaviside': _UFUNC_OPTIONS,
      'hstack': ['casting'],
      'hypot': _UFUNC_OPTIONS,
      'identity': ['like'],
      'invert': _UFUNC_OPTIONS,
      'isfinite': _UFUNC_OPTIONS,
      'isin': ['kind'],
      'isinf': _UFUNC_OPTIONS,
      'isnan': _UFUNC_OPTIONS,
      'lcm': _UFUNC_OPTIONS,
      'ldexp': _UFUNC_OPTIONS,
      'left_shift': _UFUNC_OPTIONS,
      'less': _UFUNC_OPTIONS,
      'less_equal': _UFUNC_OPTIONS,
      'load': ['mmap_mode', 'allow_pickle', 'fix_imports', 'encoding', 'max_header_size'],
      'log': _UFUNC_OPTIONS,
      'log10': _UFUNC_OPTIONS,
      'log1p': _UFUNC_OPTIONS,
      'log2': _UFUNC_OPTIONS,
      'logaddexp': _UFUNC_OPTIONS + ['x1', 'x2'],
      'logaddexp2': _UFUNC_OPTIONS + ['x1', 'x2'],
      'logical_and': _UFUNC_OPTIONS + ['x1', 'x2'],
      'logical_not': _UFUNC_OPTIONS,
      'logical_or': _UFUNC_OPTIONS + ['x1', 'x2'],
      'logical_xor': _UFUNC_OPTIONS + ['x1', 'x2'],
      'matmul': _UFUNC_OPTIONS + ['axes', 'axis', 'keepdims'],
      'matvec': _UFUNC_OPTIONS + ['axes', 'axis', 'keepdims'],
      'maximum': _UFUNC_OPTIONS + ['x1', 'x2'],
      'minimum': _UFUNC_OPTIONS + ['x1', 'x2'],
      'mod': _UFUNC_OPTIONS,
      'modf': _UFUNC_OPTIONS,
      'multiply': _UFUNC_OPTIONS + ['x1', 'x2'],
      'nanpercentile': ['weights'],
      'nanquantile': ['weights'],
      'nanstd': ['correction'],
      'nanvar': ['correction'],
      'negative': _UFUNC_OPTIONS + ['x'],
      'nextafter': _UFUNC_OPTIONS,
      'not_equal': _UFUNC_OPTIONS,
      'ones': ['order', 'like'],
      'ones_like': ['subok', 'order'],
      'partition': ['kind', 'order'],
      'percentile': ['weights'],
      'positive': _UFUNC_OPTIONS,
      'pow': _UFUNC_OPTIONS,
      'power': _UFUNC_OPTIONS,
      'promote_types': ['type1', 'type2'],
      'quantile': ['weights'],
      'rad2deg': _UFUNC_OPTIONS,
      'radians': _UFUNC_OPTIONS,
      'reciprocal': _UFUNC_OPTIONS,
      'remainder': _UFUNC_OPTIONS,
      'right_shift': _UFUNC_OPTIONS,
      'rint': _UFUNC_OPTIONS,
      'row_stack': ['casting'],
      'sign': _UFUNC_OPTIONS,
      'signbit': _UFUNC_OPTIONS,
      'sin': _UFUNC_OPTIONS,
      'sinh': _UFUNC_OPTIONS,
      'spacing': _UFUNC_OPTIONS,
      'sqrt': _UFUNC_OPTIONS,
      'square': _UFUNC_OPTIONS,
      'stack': ['casting'],
      'subtract': _UFUNC_OPTIONS + ['x1', 'x2'],
      'tan': _UFUNC_OPTIONS,
      'tanh': _UFUNC_OPTIONS,
      'tri': ['like'],
      'true_divide': _UFUNC_OPTIONS,
      'trunc': _UFUNC_OPTIONS,
      'unravel_index': ['order'],
      'vecdot': _UFUNC_OPTIONS + ['axes', 'keepdims'],
      'vecmat': _UFUNC_OPTIONS + ['axes', 'axis', 'keepdims'],
      'vstack': ['casting'],
      'zeros': ['order', 'like'],
