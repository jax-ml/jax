...
class ExtendTest(jtu.JaxTestCase):
  ...
  def test_symbols(self):
    ...
    self.assertIs(jex.core.set_current_trace, core.set_current_trace)
    self.assertIs(jex.core.take_current_trace, core.take_current_trace)
    self.assertIs(jex.core.TraceTag, core.TraceTag)
