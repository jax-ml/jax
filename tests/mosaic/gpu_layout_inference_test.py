...
class LayoutInferenceTest(parameterized.TestCase):
  ...
  @parameterized.parameters(
      (mgpu.dialect.AsyncLoadOp, 1),
      (mgpu.dialect.AsyncLoadOp, 2),
      (mgpu.dialect.AsyncStoreOp, 1),
      (mgpu.dialect.AsyncStoreOp, 2),
      (mgpu.dialect.AsyncPrefetchOp, 1),
      (mgpu.dialect.AsyncPrefetchOp, 2),
  )
