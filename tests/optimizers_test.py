...
class OptimizerTests(jtu.JaxTestCase):
    ...
    def _CheckFuns(self, optimizer, loss, x0, *args):
        ...
        self.assertEqual(
            tree_util.tree_structure(opt_state), tree_util.tree_structure(opt_state2)
        )
    ...
    def testSgdVectorExponentialDecaySchedule(self):
        ...
        x0 = np.ones(2)
        step_schedule = optimizers.exponential_decay(0.1, 3, 2.0)
    ...
    def testSgdVectorInverseTimeDecaySchedule(self):
        ...
        x0 = np.ones(2)
        step_schedule = optimizers.inverse_time_decay(0.1, 3, 2.0)
        self._CheckFuns(optimizers.sgd, loss, x0, step_schedule)
    ...
    def testMomentumVectorInverseTimeDecayStaircaseSchedule(self):
        ...
        x0 = np.ones(2)
        step_sched = optimizers.inverse_time_decay(0.1, 3, 2.0, staircase=True)
        mass = 0.9
