...
class VectorSubcoreTestWithTCTiling(TCTilingTest, VectorSubcoreTest):
  pass
...
class ScalarSubcoreTestWithTCTiling(TCTilingTest, ScalarSubcoreTest):
  pass
...
class PipelineTestWithTCTiling(TCTilingTest, PipelineTest):
  pass
