...
def vector_subcore_kernel(*, dimension_semantics=None, **kwargs):
  ...
  def test_parallel_loop_with_carry(self):
    ...
    def kernel(x_ref, o_ref):
      ...
      def _():
        ...
        @plsc.parallel_loop(0, x_ref.shape[0], chunk_size, carry=init)
        ...
        o_ref[pl.ds(0, chunk_size)] = jnp.where(
            ...
            for_each_chunk.result[0] * sentinel_multiplier,
            for_each_chunk.result[1])
