...
class GpuInfoTest(jtu.JaxTestCase):
  ...
  @parameterized.parameters([
    ("NVIDIA A100-SXM4-40GB", pl.GpuVersion.A100),
    ("NVIDIA A100-SXM4-80GB", pl.GpuVersion.A100),
    ("NVIDIA A100-PCIE-40GB", pl.GpuVersion.A100),
    ("NVIDIA A100 80GB PCIe", pl.GpuVersion.A100),
    ("NVIDIA A10 WHATEVER", pl.GpuVersion.A10),
    ("NVIDIA H100 80GB HBM3", pl.GpuVersion.H100),
    ("NVIDIA H100 PCIe", pl.GpuVersion.H100),
    ("NVIDIA H100 NVL", pl.GpuVersion.H100),
  ])
