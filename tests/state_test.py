...
class StatePrimitivesTest(jtu.JaxTestCase):
  ...
  @parameterized.named_parameters(
      ...
      {"testcase_name": "get_with_ref_multiple_at",
  ...
  @parameterized.named_parameters(
      {"testcase_name": "invalid_val_shape", "ref_shape": (1, 2),
           "ref_dtype": jnp.float32, "val_shape": (2,), "val_dtype": jnp.float32,
           "idx": (), "should_error": True},
      {"testcase_name": "invalid_val_shape_slice", "ref_shape": (1, 2),
           "ref_dtype": jnp.float32, "val_shape": (2,), "val_dtype": jnp.float32,
           "idx": (slice(None),), "should_error": True},
      {"testcase_name": "trivial_swap", "ref_shape": (1, 2),
           "ref_dtype": jnp.float32, "val_shape": (1, 2), "val_dtype": jnp.float32,
           "idx": (), "out_shape": (1, 2), "out_dtype": jnp.float32},
      {"testcase_name": "bad_dtype", "ref_shape": (1, 2),
           "ref_dtype": jnp.int32, "val_shape": (1, 2), "val_dtype": jnp.float32,
           "idx": (), "should_error": True},
      {"testcase_name": "swap_with_index", "ref_shape": (1, 2),
           "ref_dtype": jnp.float32, "val_shape": (2,), "val_dtype": jnp.float32,
           "idx": (0,), "out_shape": (2,), "out_dtype": jnp.float32},
      {"testcase_name": "swap_with_nonleading_index", "ref_shape": (1, 2),
           "ref_dtype": jnp.float32, "val_shape": (1,), "val_dtype": jnp.float32,
           "idx": (slice(None), 0), "out_shape": (1,), "out_dtype": jnp.float32},
      {"testcase_name": "swap_with_nonleading_index_bad_val", "ref_shape": (1, 2),
           "ref_dtype": jnp.float32, "val_shape": (2,), "val_dtype": jnp.float32,
           "idx": (slice(None), 0), "should_error": True},
      {"testcase_name": "swap_with_array_index", "ref_shape": (1, 2, 3, 4),
           "ref_dtype": jnp.float32, "val_shape": (2, 2, 3, 4), "val_dtype": jnp.float32,
           "idx": (np.array([0, 1]),), "out_shape": (2, 2, 3, 4),
           "out_dtype": jnp.float32},
      {"testcase_name": "swap_with_multiple_array_index",
           "ref_shape": (1, 3, 2, 4), "ref_dtype": jnp.float32,
           "val_shape": (2, 2, 4), "val_dtype": jnp.float32,
           "idx": (np.array([0, 1]), np.array([0, 1])),
           "out_shape": (2, 2, 4), "out_dtype": jnp.float32},
      {"testcase_name": "swap_with_nonleading_multiple_array_index",
           "ref_shape": (1, 3, 2, 4), "ref_dtype": jnp.float32,
           "val_shape": (2, 1, 2), "val_dtype": jnp.float32,
           "idx": (slice(None), np.array([0, 1]), slice(None), np.array([0, 1])),
           "out_shape": (2, 1, 2), "out_dtype": jnp.float32},
      {"testcase_name": "swap_with_nontrivial_slice",
           "ref_shape": (1, 3, 2, 4), "ref_dtype": jnp.float32,
           "idx": (slice(0, 1), np.array([0, 1]), slice(None), np.array([0, 1])),
           "val_shape": (2, 1, 2), "val_dtype": jnp.float32,
           "out_shape": (2, 1, 2), "out_dtype": jnp.float32},
      {"testcase_name": "swap_with_nontrivial_slice2",
           "ref_shape": (1, 3, 2, 4), "ref_dtype": jnp.float32,
           "idx": (slice(0, 1), slice(1, 3), slice(None), slice(None)),
           "val_shape": (1, 2, 2, 4), "val_dtype": jnp.float32,
           "out_shape": (1, 2, 2, 4), "out_dtype": jnp.float32},
      {"testcase_name": "swap_with_ref_simple_at",
           "ref_shape": (1, 3, 2, 4), "ref_dtype": jnp.float32,
  ...
  @parameterized.named_parameters(
      ...
      {"testcase_name": "invalid_val_shape_slice", "ref_shape": (1, 2),
           "ref_dtype": jnp.float32, "val_shape": (2,), "val_dtype": jnp.float32,
           "idx": (slice(None),), "should_error": True},
      {"testcase_name": "trivial_addupdate", "ref_shape": (1, 2),
           "ref_dtype": jnp.float32, "val_shape": (1, 2), "val_dtype": jnp.float32,
           "idx": (),},
      {"testcase_name": "bad_dtype", "ref_shape": (1, 2),
           "ref_dtype": jnp.int32, "val_shape": (1, 2), "val_dtype": jnp.float32,
           "idx": (), "should_error": True},
      {"testcase_name": "addupdate_with_index", "ref_shape": (1, 2),
           "ref_dtype": jnp.float32, "val_shape": (2,), "val_dtype": jnp.float32,
           "idx": (0,),},
      {"testcase_name": "addupdate_with_nonleading_index", "ref_shape": (1, 2),
           "ref_dtype": jnp.float32, "val_shape": (1,), "val_dtype": jnp.float32,
           "idx": (slice(None), 0)},
      {"testcase_name": "addupdate_with_nonleading_index_bad_val", "ref_shape": (1, 2),
           "ref_dtype": jnp.float32, "val_shape": (2,), "val_dtype": jnp.float32,
           "idx": (slice(None), 0), "should_error": True},
      {"testcase_name": "addupdate_with_array_index", "ref_shape": (1, 2, 3, 4),
           "ref_dtype": jnp.float32, "val_shape": (2, 2, 3, 4), "val_dtype": jnp.float32,
           "idx": (np.array([0, 1]),)},
      {"testcase_name": "addupdate_with_multiple_array_index",
           "ref_shape": (1, 3, 2, 4), "ref_dtype": jnp.float32,
           "val_shape": (2, 2, 4), "val_dtype": jnp.float32,
           "idx": (np.array([0, 1]), np.array([0, 1]))},
      {"testcase_name": "addupdate_with_nonleading_multiple_array_index",
           "ref_shape": (1, 3, 2, 4), "ref_dtype": jnp.float32,
           "val_shape": (2, 1, 2), "val_dtype": jnp.float32,
           "idx": (slice(None), np.array([0, 1]), slice(None), np.array([0, 1]))},
      {"testcase_name": "ref_with_simple_at",
           "ref_shape": (1, 3, 2, 4), "ref_dtype": jnp.float32,
           "val_shape": (2, 2), "val_dtype": jnp.float32,
           "idx": (np.array([0, 1]), slice(None), np.array([0, 1])),
           "at_indices": ((0,),)},
      {"testcase_name": "ref_with_simple_at2",
           "ref_shape": (3, 3, 2, 4), "ref_dtype": jnp.float32,
           "val_shape": (2, 3, 4), "val_dtype": jnp.float32,
           "idx": (np.array([0, 1]), slice(None), np.array([0, 1])),
           "at_indices": ((slice(0, 3),),)},
      {"testcase_name": "ref_with_multiple_at",
           "ref_shape": (3, 3, 2, 4), "ref_dtype": jnp.float32,
           "val_shape": (2, 2), "val_dtype": jnp.float32,
           "idx": (np.array([0, 1]), slice(None), np.array([0, 1])),
           "at_indices": ((slice(0, 3),), (0,))},
      {"testcase_name": "ref_with_multiple_at2",
           "ref_shape": (3, 3, 2, 4), "ref_dtype": jnp.float32,
           "val_shape": (2, 2), "val_dtype": jnp.float32,
           "idx": (np.array([0, 1]), slice(None), np.array([0, 1])),
