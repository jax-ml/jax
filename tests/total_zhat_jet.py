...
def test_sol_sin_exp():
  ...
  t_terms = zero_terms(t_eval, 1)
  j1 = jet(f, (z_eval, t_eval), [z_terms, t_terms])

  j2 = jet(f, (z_eval, t_eval), (shift_jet(j1), std_terms(t_eval,2)))

  z_terms2 = shift_jet(j2)
  j3 = jet(f, (z_eval, t_eval), (shift_jet(j2),std_terms(t_eval,3)))


  jet(f, (z_eval, t_eval), ((1.,z_terms2[1],0.),std_terms(t_eval,3)))
