...
MLIR_CAPI_EXPORTED bool MosaicGpuIsATileTransformAttr(MlirAttribute attr);

MLIR_CAPI_EXPORTED MlirAttribute MosaicGpuTileTransformAttrGet(
    MlirContext ctx, int32_t* tiling, int32_t tiling_size);

MLIR_CAPI_EXPORTED int32_t
MosaicGpuTileTransformAttrGetTilingSize(MlirAttribute attr);

MLIR_CAPI_EXPORTED int32_t
MosaicGpuTileTransformAttrGetTiling(MlirAttribute attr, int32_t index);

//===----------------------------------------------------------------------===//
// TransposeTransformAttr
//===----------------------------------------------------------------------===//

MLIR_CAPI_EXPORTED bool MosaicGpuIsATransposeTransformAttr(MlirAttribute attr);

MLIR_CAPI_EXPORTED MlirAttribute MosaicGpuTransposeTransformAttrGet(
    MlirContext ctx, int32_t* permutation, int32_t permutation_size);

MLIR_CAPI_EXPORTED int32_t
MosaicGpuTransposeTransformAttrGetPermutationSize(MlirAttribute attr);

MLIR_CAPI_EXPORTED int32_t MosaicGpuTransposeTransformAttrGetPermutation(
