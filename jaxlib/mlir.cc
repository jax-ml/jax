...
absl::StatusOr<nb::bytes> PySerializePortableArtifact(
  ...
  TF_ASSIGN_OR_RETURN(
      std::string bytecode,
      xla::SerializeUsingVersionedStablehlo(*module, target, sdy_version,
                                            /*inplace=*/true,
...
absl::StatusOr<nb::bytes> PySerializePortableArtifact(
  ...
  TF_ASSIGN_OR_RETURN(
      std::string bytecode,
      xla::SerializeUsingVersionedStablehlo(module_op, target, sdy_version,
                                            /*inplace=*/false,
                                            /*allow_mixed_serialization*/
                                            use_mixed_serialization));
  return nb::bytes(bytecode.data(), bytecode.size());
