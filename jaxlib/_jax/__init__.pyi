...
class CompileOptions:
  ...
  @property
  def individually_defined_output_indices(self) -> list[int]: ...
  @individually_defined_output_indices.setter
  def individually_defined_output_indices(
...
class ExecutableBuildOptions:
  ...
  def result_layout(
      self,
  ) -> jaxlib._hlo.Shape | None: ...
  @result_layout.setter
  def result_layout(
      self,
      arg: jaxlib._hlo.Shape,
      /,
...
class Client:
  ...
  @property
  def unsafe_client_pointer(self) -> int: ...
  @property
  def runtime_type(self) -> str: ...
  @property
  def is_c_api(self) -> bool: ...
  ...
  def dma_unmap(self, address: int) -> None: ...
...
def get_pjrt_plugin(platform_name: str) -> CapsuleType: ...
...
def array_result_handler(
    aval: object, sharding: object, committed: bool
) -> ResultHandler: ...
...
class GSPMDSharding(Sharding):
  ...
  def __init__(
      self,
      devices: DeviceList,
      op_sharding: jaxlib._hlo.OpSharding,
      memory_kind: object | None = ...,
  ) -> None: ...
  @overload
  def __init__(
      self,
      devices: DeviceList,
      op_sharding: jaxlib._hlo.HloSharding,
      memory_kind: object | None = ...,
  ) -> None: ...
  @overload
  def __init__(
...
def set_pspec_unconstrained(arg: object, /) -> None: ...
def canonicalize_partition(partition: object | None) -> object: ...
def canonicalize_partitions(partitions: tuple) -> tuple: ...
...
class CompiledMemoryStats:
  ...
  @property
  def total_allocation_bytes(self) -> int: ...
  @total_allocation_bytes.setter
  def total_allocation_bytes(self, arg: int, /) -> None: ...

  @property
  def indefinite_allocations(self) -> int: ...
  @indefinite_allocations.setter
  def indefinite_allocations(self, arg: int, /) -> None: ...

  @property
  def peak_unpadded_heap_bytes(self) -> int: ...
  @peak_unpadded_heap_bytes.setter
  def peak_unpadded_heap_bytes(self, arg: int, /) -> None: ...
...
class LoadedExecutable:
  ...
  @property
  def unsafe_executable_pointer(self) -> int: ...
  @property
...
def set_execution_options_thread_local(
    *, custom_options: dict[str, Any] | None = ...
) -> None: ...
def get_execution_options_thread_local() -> ExecutionOptions: ...
...
class TransferConnection:
  ...
  def _pull_flat(
      ...
      uuid: int,
      backend: Client,
      py_avals: Sequence[object],
      timeout: object | None = ...,
  ) -> list[Array]: ...
  def _pull_into_flat(
      self,
      uuid: int,
      dests: Sequence[Array],
...
class TransferServer:
  ...
  def _await_pull_flat(
      self, uuid: int, inputs: Sequence[Array], timeout: object | None = ...
  ) -> None: ...
...
def batched_copy_to_host_async(arrays: Sequence) -> None: ...
...
def set_invalid_input_exception(arg: object, /) -> None: ...
def set_valid_dtypes(arg: object, /) -> None: ...
def register_canonicalize_value_handler(
    type: object, handler: object | None
) -> None:
...
def canonicalize_value(arg: Any, /) -> Any: ...
