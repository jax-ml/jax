...
class ProgramShape:
  def __init__(
      self, arg0: Sequence["xla::Shape"], arg1: "xla::Shape", /
  ) -> None: ...
  def parameter_shapes(self) -> list["xla::Shape"]: ...
  def result_shape(self) -> "xla::Shape": ...
...
class CompileOptions:
  ...
  @property
  def argument_layouts(self) -> list["xla::Shape"] | None: ...
  @argument_layouts.setter
  def argument_layouts(self, arg: Sequence["xla::Shape"], /) -> None: ...
  @property
...
def register_custom_type_id(type_name: str, type_id: object) -> None: ...
...
class ExecutableBuildOptions:
  ...
  @property
  def result_layout(self) -> "xla::Shape" | None: ...
  @result_layout.setter
  def result_layout(self, arg: "xla::Shape", /) -> ExecutableBuildOptions: ...
  @property
  def num_replicas(self) -> int: ...
  @num_replicas.setter
...
class HloSharding:
  ...
  @staticmethod
  def tuple_sharding(
      arg0: "xla::Shape", arg1: Sequence[HloSharding], /
  ) -> HloSharding:
  ...
  def tile(self, arg: "xla::Shape", /) -> "xla::Shape": ...
...
class Client:
  ...
  def make_python_callback_from_host_send_and_recv(
      self,
      callable: Callable,
      operand_shapes: Sequence["xla::Shape"],
      result_shapes: Sequence["xla::Shape"],
...
class PjRtLayout:
  ...
  def __hash__(self) -> int: ...
  def _xla_layout(self) -> "xla::Layout": ...
  def __getstate__(self) -> tuple: ...
  def __setstate__(self, arg: tuple, /) -> None: ...
