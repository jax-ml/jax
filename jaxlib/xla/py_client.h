...
#ifndef JAXLIB_XLA_PY_CLIENT_H_
#define JAXLIB_XLA_PY_CLIENT_H_
...
class PyClient {
 public:
  ...
  static absl::StatusOr<nb_class_ptr<PyLoadedExecutable>> Compile(
      ...
      ifrt::DeviceListRef execution_devices, CompileOptions options,
  ...
  static absl::StatusOr<nb_class_ptr<PyLoadedExecutable>> DeserializeExecutable(
      ...
      ifrt::DeviceListRef execution_devices,
