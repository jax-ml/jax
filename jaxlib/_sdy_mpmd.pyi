...
class MpmdLoadedExecutable:
  ...
  def input_shardings(
      ...
      jaxlib._hlo.OpSharding
  ]: ...
  def output_shardings(
      self,
  ) -> list[
      jaxlib._hlo.OpSharding
  ]: ...
  def input_layouts(self) -> list[jax.jaxlib._jax.PjRtLayout]: ...
  def output_layouts(self) -> list[jax.jaxlib._jax.PjRtLayout]: ...
