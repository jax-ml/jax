...
void GetLapackKernelsFromScipy() {
  ...
  AssignKernelFn<PivotingQrFactorizationComplex<DataType::C64>>(lapack_ptr("cgeqp3"));
  AssignKernelFn<PivotingQrFactorizationComplex<DataType::C128>>(lapack_ptr("zgeqp3"));
