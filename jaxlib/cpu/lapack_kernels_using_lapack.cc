...
jax::PivotingQrFactorizationComplex<ffi::DataType::C64>::FnType cgeqp3_;
jax::PivotingQrFactorizationComplex<ffi::DataType::C128>::FnType zgeqp3_;
...
static auto init = []() -> int {
  ...
  AssignKernelFn<PivotingQrFactorizationComplex<ffi::DataType::C64>>(cgeqp3_);
  AssignKernelFn<PivotingQrFactorizationComplex<ffi::DataType::C128>>(zgeqp3_);
