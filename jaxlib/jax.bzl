...
load("@org_tensorflow//tensorflow:tensorflow.bzl", _if_windows = "if_windows")
load("@org_tensorflow//tensorflow:tensorflow.default.bzl", _pybind_extension = "pybind_extension")
