      ...
      [](bool asynchronous,
        ...
        std::unique_ptr<ifrt::PjRtClient> ifrt_client;
        {
          ...
          if (cross_host_transfer_socket_address.has_value()) {
            ifrt_options.transfer_server_factory = xla::ValueOrThrow(
                xla::ifrt::PjRtTransferServer::MakePjRtTransferServerFactory(
                    /*transfer_size=*/1024 * 1024,
                    ifrt_options.cross_host_transfer_timeout,
                    ifrt_options.kv_store, *cross_host_transfer_socket_address,
                    cross_host_transport_addresses));
          }
#endif
#endif
          ifrt_client =
