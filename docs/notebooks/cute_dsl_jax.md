...
b = jax.random.normal(jax.random.key(1), (N,), dtype=jnp.float32)
...
y = jax.random.normal(jax.random.key(43), (N,), dtype=jnp.float32)
...
bias = jax.random.normal(jax.random.key(100), (WIDTH,), dtype=jnp.float32)
...
B = jax.random.normal(jax.random.key(1), (K, N), dtype=jnp.float32)
...
M, N, K = 512, 512, 512
A = jax.random.normal(jax.random.key(0), (M, K), dtype=jnp.float32)
B = jax.random.normal(jax.random.key(1), (K, N), dtype=jnp.float32)
...
b = jax.random.normal(jax.random.key(456), (M, N), dtype=jnp.float32)
...
for shape in [(512, 256), (1024, 512), (2048, 1024)]:
    a = jax.random.normal(jax.random.key(42), shape, dtype=jnp.float32)
    b = jax.random.normal(jax.random.key(43), shape, dtype=jnp.float32)
