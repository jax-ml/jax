...
but decorating a method within a class introduces some complication. See `🔪 JAX - The Sharp Bits 🔪 
<https://jax.readthedocs.io/en/latest/notebooks/Common_Gotchas_in_JAX.html#jit-and-methods>`_
for details and strategies.
