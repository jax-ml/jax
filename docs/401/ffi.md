...
We discuss this batching behavior in more detail [below](jax-401-ffi-call-vmap), but the general idea is that it can be useful to transparently handle batching in the left-most dimensions of the input arguments.
