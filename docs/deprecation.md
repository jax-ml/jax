...
* All NumPy feature releases in the 24 months prior to each JAX release. For example:
  ...
  * **NumPy 2.5** was released June 2026, and will be supported in new JAX releases at least until **June 2028**.
...
* All SciPy feature releases in the 24 months prior to each JAX release. For example:
  ...
  * **SciPy 1.18** was released June 2026, and will be supported in new JAX releases at least until **June 2028**.
