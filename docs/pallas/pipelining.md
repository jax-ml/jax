...
What is the performance of a pipelined kernel? This question can vary depending on where the bottleneck of the hardware is. We are typically interested in 3 quantities:
