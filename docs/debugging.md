...
* [Interactive inspection with `jax.debug`](debugging/print_breakpoint)
* [Functional error checks with jax.experimental.checkify](debugging/checkify_guide)
* [Throwing Python errors with JAX’s debug flags](debugging/flags)

### Interactive inspection with `jax.debug`

Complete guide [here](debugging/print_breakpoint)
...
[Read more](debugging/print_breakpoint).

### Functional error checks with `jax.experimental.checkify`

Complete guide [here](debugging/checkify_guide)
...
[Read more](debugging/checkify_guide).

### Throwing Python errors with JAX's debug flags

Complete guide [here](debugging/flags)
