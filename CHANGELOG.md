...
* Breaking changes
  ...
  * `jax.device_put_replicated` and `jax.device_put_sharded` have been fully
    removed from the public API (they now raise standard `AttributeError`
    instead of custom deprecation errors).
