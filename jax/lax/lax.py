...
def tie_in(x, y):
  ...
  `tie_in` provides blunt control over this mechanism.
  When staging to XLA, and `x` is already staged, then the result of `tie_in` is
  y, but staged to XLA. Downstream use of the result will also be staged to XLA.
  """
