...
def dot_product_attention(
    ...
    *,
    ...
    implementation: Literal['xla', 'cudnn'] | None = ...) -> Array: ...
...
def get_scaled_dot_general_config(mode: Literal['nvfp4', 'mxfp8'],
                                  global_scale: Array | None = ...) -> BlockScaleConfig: ...
...
@overload
def logsumexp(a: ArrayLike, axis: _Axis = ..., b: ArrayLike | None = ...,
              keepdims: bool = ..., return_sign: Literal[False] = ..., where: ArrayLike | None = ...) -> Array: ...

@overload
def logsumexp(a: ArrayLike, axis: _Axis = ..., b: ArrayLike | None = ...,
              keepdims: bool = ..., *, return_sign: Literal[True], where: ArrayLike | None = ...) -> tuple[Array, Array]: ...

@overload
def logsumexp(a: ArrayLike, axis: _Axis = ..., b: ArrayLike | None = ...,
              keepdims: bool = ..., return_sign: bool = ..., where: ArrayLike | None = ...) -> Array | tuple[Array, Array]: ...
