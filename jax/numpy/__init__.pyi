...
def convolve(a: ArrayLike, v: ArrayLike, mode: str = ..., *,
             maxlag: int | None = ...,
             lags: range | slice | Sequence[int] | _np.ndarray | None = ...,
...
def correlate(a: ArrayLike, v: ArrayLike, mode: str = ..., *,
              ...
              precision: PrecisionLike = ...,
              preferred_element_type: DTypeLike | None = ...) -> Array: ...
def correlation_lags(a_len: int, v_len: int, mode: str | None = ..., *,
                     maxlag: int | None = ...,
                     lags: range | slice | Sequence[int] | _np.ndarray | None = ...) -> Array: ...
...
def min(a: ArrayLike, axis: _Axis = ..., out: None = ...,
        keepdims: builtins.bool = ..., initial: ArrayLike | None = ...,
        where: ArrayLike | None = ...) -> Array: ...
def minmax(a: ArrayLike, axis: _Axis = ..., out: None = ...,
           keepdims: builtins.bool = ...,
           initial: ArrayLike | tuple[ArrayLike, ArrayLike] | None = ...,
           where: ArrayLike | None = ...) -> tuple[Array, Array]: ...
minimum: BinaryUfunc
...
def percentile(a: ArrayLike, q: ArrayLike,
               axis: int | tuple[int, ...] | None = ...,
               out: None = ..., overwrite_input: builtins.bool = ..., method: str = ...,
               keepdims: builtins.bool = ..., *, interpolation: DeprecatedArg | str = ...,
               out_sharding: NamedSharding | P | None = ...) -> Array: ...
...
def take_along_axis(
    ...
    *,
    wrap_negative_indices: builtins.bool = ...,
) -> Array: ...
...
def trim_zeros(filt: ArrayLike, trim: str = ..., axis: int | Sequence[int] | None = ...) -> Array: ...
...
@overload
def where(condition: ArrayLike, /, *, size: int | None = ...,
          fill_value: None | ArrayLike | tuple[ArrayLike, ...] = ...
          ) -> tuple[Array, ...]: ...
