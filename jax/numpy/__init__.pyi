...
class UnaryUfunc(Protocol):
  def __call__(self, x: ArrayLike, /) -> Array: ...
  def at(self, a: ArrayLike, indices: Any, /, *, inplace: builtins.bool = True) -> Array: ...
...
bitwise_count: UnaryUfunc
bitwise_invert: UnaryUfunc
def bitwise_left_shift(x: ArrayLike, y: ArrayLike, /) -> Array: ...
bitwise_not: UnaryUfunc
