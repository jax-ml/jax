...
def all(a: ArrayLike, axis: _Axis = ..., out: None = ...,
        keepdims: bool = ..., *, where: Optional[ArrayLike] = ...) -> Array: ...
...
@overload
def average(a: ArrayLike, axis: _Axis = ..., weights: Optional[ArrayLike] = ..., *,
            returned: Literal[True], keepdims: bool = False) -> tuple[Array, Array]: ...
@overload
def average(a: ArrayLike, axis: _Axis = ..., weights: Optional[ArrayLike] = ...,
...
@overload
def broadcast_shapes(*shapes: tuple[Union[int, _core.Tracer], ...]
...
def convolve(a: ArrayLike, v: ArrayLike, mode: str = ..., *,
             ...
             preferred_element_type: Optional[dtype] = ...) -> Array: ...
def copy(a: ArrayLike, order: Optional[str] = ...) -> Array: ...
def copysign(x: ArrayLike, y: ArrayLike, /) -> Array: ...
def corrcoef(x: ArrayLike, y: Optional[ArrayLike] = ..., rowvar: bool = ...) -> Array: ...
...
def count_nonzero(a: ArrayLike, axis: _Axis = ...,
                  keepdims: bool = ...) -> Array: ...
def cov(m: ArrayLike, y: Optional[ArrayLike] = ..., rowvar: bool = ...,
        bias: bool = ..., ddof: Optional[int] = ...,
...
def histogram(a: ArrayLike, bins: ArrayLike = ...,
              ...
              density: Optional[bool] = ...) -> tuple[Array, Array]: ...
def histogram2d(
    x: ArrayLike,
    y: ArrayLike,
...
def intersect1d(ar1: ArrayLike, ar2: ArrayLike, assume_unique: bool = ...,
                return_indices: bool = ...) -> Union[Array, tuple[Array, Array, Array]]: ...
...
def mean(a: ArrayLike, axis: _Axis = ..., dtype: DTypeLike = ...,
         out: None = ..., keepdims: bool = ..., *,
         where: Optional[ArrayLike] = ...) -> Array: ...
def median(a: ArrayLike, axis: Optional[Union[int, tuple[int, ...]]] = ...,
           out: None = ..., overwrite_input: bool = ...,
           keepdims: bool = ...) -> Array: ...
def meshgrid(*xi: ArrayLike, copy: bool = ..., sparse: bool = ...,
...
nan: float
def nan_to_num(x: ArrayLike, copy: bool = ..., nan: ArrayLike = ...,
...
def polyfit(x: Array, y: Array, deg: int, rcond: Optional[float] = ...,
            full: bool = ..., w: Optional[Array] = ..., cov: bool = ...
...
def squeeze(
    a: ArrayLike, axis: Optional[Union[int, tuple[int, ...]]] = ...
) -> Array: ...
def stack(
    arrays: Union[_np.ndarray, Array, Sequence[ArrayLike]],
    axis: int = ...,
...
def std(a: ArrayLike, axis: _Axis = ..., dtype: DTypeLike = ...,
        out: None = ..., ddof: int = ..., keepdims: bool = ..., *,
        where: Optional[ArrayLike] = ...) -> Array: ...
...
def unique(ar: ArrayLike, return_index: bool = ..., return_inverse: bool = ...,
           ...
           *, size: Optional[int] = ..., fill_value: Optional[ArrayLike] = ...
): ...
def unpackbits(
    a: ArrayLike,
    axis: Optional[int] = ...,
...
def vander(
    x: ArrayLike, N: Optional[int] = ..., increasing: bool = ...
) -> Array: ...
