...
@partial(core.jax_boundary, api_name="jax.jacfwd")
...
@partial(core.jax_boundary, api_name="jax_saved_input_vjp")
...
@partial(core.jax_boundary, api_name="jax.linear_transpose")
...
@api_boundary
@partial(core.jax_boundary, api_name="jax.eval_shape")
