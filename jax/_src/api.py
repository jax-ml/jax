...
def vmap[F: Callable](
  ...
  Args:
    ...
    in_axes: An integer, None, or sequence of values specifying which input
      ...
      https://docs.jax.dev/en/latest/101/pytrees.html#transformation-parameters-can-be-pytrees-too
...
def clear_caches():
  ...
  ``jax.clear_caches()`` is the supported API for clearing all of JAX's
  internal caches.
  """
