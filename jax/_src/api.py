...
@partial(core.repro_boundary, api_name="jax.jit")
def jit(
  fun: Callable, /, *,
...
@partial(core.repro_boundary, api_name="jax.grad")
...
@partial(core.repro_boundary, api_name="jax.value_and_grad")
...
@partial(core.repro_boundary, api_name="jax.fwd_and_bwd")
def fwd_and_bwd(
...
@partial(core.repro_boundary, api_name="jax.jacfwd")
...
@partial(core.repro_boundary, api_name="jax.jacrev")
...
@partial(core.repro_boundary, api_name="jax.hessian")
...
@partial(core.repro_boundary, api_name="jax.vmap")
def vmap(fun: F,
...
@partial(core.repro_boundary, api_name="jax.pmap")
def pmap(
    fun: Callable,
    axis_name: AxisName | None = None,
    *,
...
@api_boundary
@partial(core.repro_boundary, api_name="jax.jvp")
def jvp(
...
@partial(core.repro_boundary, api_name="jax.linearize")
...
@api_boundary
@partial(core.repro_boundary, api_name="jax.vjp")
def vjp(
...
@partial(core.repro_boundary, api_name="jax.linear_transpose")
...
@partial(core.repro_boundary, api_name="jax.make_japr")
def make_jaxpr(
    fun: Callable,
    static_argnums: int | Iterable[int] = (),
    axis_env: Sequence[tuple[AxisName, int]] | None = None,
...
@api_boundary
@partial(core.repro_boundary, api_name="jax.eval_shape")
...
@partial(core.repro_boundary, api_name="jax.named_call")
def named_call(
    fun: F,
    *,
    name: str | None = None,
