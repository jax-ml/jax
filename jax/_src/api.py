...
class NoFunctionType:
  """Sentinel for use in jax.jit"""
  def __repr__(self):
    return "NoFunction"

NoFunction = NoFunctionType()
  ...
  *,
  ...
  Args:
    fun: Function to be jitted. ``fun`` should be a pure function.
      ...
      weakly-referenceable. Starting in JAX v0.6.0, when ``fun`` is omitted,
  ...
  Examples:
    ...
    Starting in JAX v0.6.0, :func:`jit` supports the decorator factory pattern
  ...
  if isinstance(fun, NoFunctionType):
