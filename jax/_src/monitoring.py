...
def unregister_event_duration_listener_by_callback(
...
def unregister_event_duration_listener_by_index(index: int) -> None:
...
def unregister_event_time_span_listener_by_callback(
    callback: EventTimeSpanListenerWithMetadata,
) -> None:
...
def unregister_event_listener_by_callback(
    callback: EventListenerWithMetadata,
) -> None:
...
def unregister_scalar_listener_by_callback(
    callback: ScalarListenerWithMetadata,
) -> None:
