...
def iota_2x32_shape_lowering(ctx, *, shape):
  ...
  out_type = mlir.single_ir_type(mlir.aval_to_ir_type(aval_out))
  counts_lo = mlir.hlo.convert(out_type, counts)
  counts_hi = mlir.hlo.convert(out_type, counts_shifted)
