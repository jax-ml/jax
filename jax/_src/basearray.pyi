...
class Array:
  ...
  def __floordiv__(self, other: ArrayLike) -> Array: ...
  def __mod__(self, other: ArrayLike) -> Array: ...
  def __divmod__(self, other: ArrayLike) -> tuple[Array, Array]: ...
  def __pow__(self, other: ArrayLike) -> Array: ...
  def __lshift__(self, other: ArrayLike) -> Array: ...
  def __rshift__(self, other: ArrayLike) -> Array: ...
  def __and__(self, other: ArrayLike) -> Array: ...
  def __xor__(self, other: ArrayLike) -> Array: ...
  def __or__(self, other: ArrayLike) -> Array: ...

  def __radd__(self, other: ArrayLike) -> Array: ...  # type: ignore[misc]
  def __rsub__(self, other: ArrayLike) -> Array: ...  # type: ignore[misc]
  def __rmul__(self, other: ArrayLike) -> Array: ...  # type: ignore[misc]
  def __rmatmul__(self, other: ArrayLike) -> Array: ...
  def __rtruediv__(self, other: ArrayLike) -> Array: ...  # type: ignore[misc]
  def __rfloordiv__(self, other: ArrayLike) -> Array: ...
  def __rmod__(self, other: ArrayLike) -> Array: ...
  def __rdivmod__(self, other: ArrayLike) -> Array: ...
  def __rpow__(self, other: ArrayLike) -> Array: ...  # type: ignore[misc]
  ...
  def astype(self, dtype: DTypeLike | None = None, copy: bool = False,
             device: Device | BaseSharding | None = None) -> Array: ...
  ...
  @property
  def sharding(self) -> BaseSharding: ...
  @property
  def committed(self) -> bool: ...
  @property
  def device(self) -> Device | BaseSharding: ...
  @property
  ...
  def to_device(self, device: Device | BaseSharding, *,
