...
from typing import Any, Protocol, runtime_checkable, Self, Union
import numpy as np
...
class Array:
  ...
  def __eq__(self, other: ArrayLike) -> Array: ...  # pyrefly: ignore[bad-override]
  def __ne__(self, other: ArrayLike) -> Array: ...  # pyrefly: ignore[bad-override]
  ...
  def __rpow__(self, other: ArrayLike) -> Array: ...
