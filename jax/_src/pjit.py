...
def make_jit(fun: Callable,
  ...
  jit_info = _parse_jit_arguments(
        fun, in_shardings, out_shardings, static_argnums, static_argnames,
        donate_argnums, donate_argnames, keep_unused, device, backend, inline,
        abstracted_axes, compiler_options, use_resource_env)
...
def pjit(
  ...
  return make_jit(
      fun, in_shardings, out_shardings, static_argnums, static_argnames,
      donate_argnums, donate_argnames, keep_unused, device, backend, inline,
      abstracted_axes, compiler_options, use_resource_env=True)
