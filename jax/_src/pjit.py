...
def convert_to_metaty(arg):
  ...
  if isinstance(arg, (np.ndarray, memoryview)):
    return create_meta_ty(aval, None, None, True, True)
  return create_meta_ty(
      aval,
      getattr(arg, 'sharding', None),
      getattr(arg, 'format', None),
