...
def _pjit_lowering(ctx: mlir.LoweringRuleContext, *args, name: str,
  ...
  in_avals = hc_avals + jaxpr.in_avals
  hc_shardings = hoisted_consts_shardings(hoisted_consts)
  in_shardings = hc_shardings + in_shardings  # type: ignore
  hc_layouts = hoisted_consts_layouts(hoisted_consts, hc_avals, hc_shardings)
...
def hoisted_consts_shardings(hoisted_consts: Sequence[ArrayLike]) -> Sequence[PjitSharding]:
  return _resolve_in_shardings(
      hoisted_consts, (sharding_impls.UNSPECIFIED,) * len(hoisted_consts))

def hoisted_consts_layouts(
    hoisted_consts: Sequence[ArrayLike],
    avals: Sequence[core.AbstractValue],
    shardings: Sequence[PjitSharding]
    ) -> Sequence[Layout | None]:
  return _resolve_in_layouts(
      hoisted_consts, (None,) * len(hoisted_consts), shardings, avals)
