...
def get_compile_options(
  ...
  if compilation_cache.is_persistent_cache_enabled():
    ...
    if enabled_flags == "all" or "xla_gpu_per_fusion_autotune_cache_dir" in enabled_flags:
      ...
      autotune_cache_path.mkdir(parents=True, exist_ok=True)
      ...
      if distributed.global_state.process_id == 0:
        debug_options.xla_gpu_experimental_autotune_cache_mode = xe.AutotuneCacheMode.UPDATE
      else:
        debug_options.xla_gpu_experimental_autotune_cache_mode = xe.AutotuneCacheMode.READ
