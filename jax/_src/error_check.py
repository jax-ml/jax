...
def _is_category_disabled(
    category: Literal["nan", "divide", "oob"] | None,
) -> bool:
...
def set_error_if(
    ...
    /,
    msg: str,
    category: Literal["nan", "divide", "oob"] | None = None,
) -> None:
  ...
  Args:
    ...
    category: The category of the error. It can be "nan", "divide", or "oob".
      The error checking behavior for each category can be configured using
...
class error_checking_behavior:
  ...
  def __init__(
      self,
      *,
      all: Literal["ignore", "raise"] | None = None,
      nan: Literal["ignore", "raise"] | None = None,
      divide: Literal["ignore", "raise"] | None = None,
      oob: Literal["ignore", "raise"] | None = None,
  ) -> None:
    new_settings = {}
    if all is not None:
