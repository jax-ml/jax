...
def _use_cholesky(u, m, n, params):
  ...
  l = lax_linalg.cholesky(x, symmetrize_input=False)  # L Lᴴ = X
  l_inverse = lax_linalg.triangular_solve(l, I, left_side=True, lower=True)
  z = (u @ l_inverse.T.conj()) @ l_inverse  # Z = (U L⁻ᴴ) L⁻¹ = U X⁻¹
