...
def _while_lowering(ctx, *args, cond_jaxpr, body_jaxpr, cond_nconsts,
  ...
  with ir.InsertionPoint(cond_block):
    ...
    cond_consts = [
        mlir.ir_constant(xla.dont_canonicalize_dtype(x))
  ...
  with ir.InsertionPoint(body_block):
    ...
    body_consts = [mlir.ir_constant(xla.dont_canonicalize_dtype(x))
    ...
    if batched:
      ...
      cond_consts = [mlir.ir_constant(xla.dont_canonicalize_dtype(x))
                     for x in cond_jaxpr.consts]
