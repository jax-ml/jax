...
_Backend = Literal["mosaic", "triton", "mosaic_gpu"]
...
def _pallas_call_lowering(
  ...
  def gpu_lowering(ctx: mlir.LoweringRuleContext,
    ...
    try:
      ...
      raise _unsupported_lowering_error("gpu") from e

    return pallas_call_registration.pallas_call_lowering(  # type: ignore
        ctx, *in_nodes, **params
    )
...
def pallas_call(
  ...
  Args:
    ...
    backend: Optional string literal one of  "mosaic", "triton" or "mosaic_gpu"
