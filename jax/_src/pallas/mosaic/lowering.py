...
def _lower_jaxpr_to_for_loop(ctx: LoweringRuleContext,
  ...
  # TODO(apaszke): Remove forward_compatible check and associated code after 05.08.2026
  if unroll > 1 and ctx.forward_compatible:
  ...
  # TODO(apaszke): Remove forward_compatible check after 05.08.2026
  if unroll > 1 and not ctx.forward_compatible:
