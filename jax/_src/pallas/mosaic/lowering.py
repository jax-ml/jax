...
def _device_id_to_logical(
  ...
  def jax_fn(device_id_val):
    ...
    # Signaling the same core type without any specification does not require us
    # to have a dest_mesh, we return None for the core index.
    if (dest_kernel_type == kernel_type and dest_mesh is None
        and not core_axis_names):
