...
class Scheduler:
  ...
  def __init__(
    ...
    # Out of fetch - No more blocks to fetch.
    ...
    self.out_of_fetch = lambda bref: isinstance(bref, BufferedRef) and (
        step >= self.num_steps - bref.buffer_count + 1)
  ...
  def has_changed(self, buffered_ref):
    if not isinstance(buffered_ref, BufferedRef):
      return False
