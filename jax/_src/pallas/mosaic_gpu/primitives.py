...
def async_copy_scales_to_tmem(smem_ref: _Ref, tmem_ref: _Ref, collective: bool = False):
...
def _async_copy_to_tmem_abstract_eval(smem_ref, tmem_ref, *avals_flat, smem_tree, tmem_tree, **kwargs):
...
def _async_copy_to_tmem_lowering_rule(
    impl, ctx: lowering.LoweringRuleContext, smem_ref, tmem_ref, *leaves, smem_tree, tmem_tree, **kwargs
):
