...
def _lower_fun(
  ...
  def f_lowered(ctx: LoweringRuleContext, *args, **params):
    ...
    in_avals_ft = tree_util.FlatTree.flatten_static_argnums_argnames(
        unflat_avals,
        params,
        static_argnums=(),
    ...
    jaxpr = pe.convert_constvars_jaxpr(jaxpr.jaxpr)
...
def _lower_fn_with_avals(f, avals_in):
  def inner(ctx, *args):
    ...
    in_avals_ft = tree_util.FlatTree.flatten_args(*avals_in)
    debug_info = api_util.debug_info(
