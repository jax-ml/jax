...
def _run_scoped_lowering_rule(
  ...
  is_thread_collective = (
      collective_axes == (wg_axis,)
      if wg_axis is not None
  ...
  if wg_axis and is_thread_collective:
    gpu_dialect.barrier()
      ...
      if isinstance(aval, gpu_core.WGMMAAbstractAccumulatorRef):
        if collective_axes:
          raise ValueError(
              ...
              " are performed too, split the run_scoped into two."
          )
