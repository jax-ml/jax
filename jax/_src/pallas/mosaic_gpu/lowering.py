...
def _while_lowering_rule(
  ...
  cond_avals, body_avals, carry_avals = util.split_list(
      ctx.avals_in, [cond_nconsts, body_nconsts]
  )
  ...
  with ir.InsertionPoint.at_block_begin(before_block):
    ...
    scf_dialect.condition(_ensure_ir_value(cond, *cond_jaxpr.out_avals), before_block.arguments)
  ...
  with ir.InsertionPoint.at_block_begin(after_block):
    ...
    if loop_out:
      scf_dialect.yield_(carry_treedef.flatten_up_to(loop_out))
