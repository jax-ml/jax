...
def fuse_jaxpr(
  ...
  debug_info = api_util.debug_info(
      "fusible_wrapper", fusible_wrapper, (), {}
  )
  wrapped_fun = lu.wrap_init(fusible_wrapper, debug_info=debug_info)
  jaxpr_inner, _, consts_inner = pe.trace_to_jaxpr_dynamic(
      wrapped_fun, [], lower=True
  )

  return jax_core.eval_jaxpr(jaxpr_inner, consts_inner)
