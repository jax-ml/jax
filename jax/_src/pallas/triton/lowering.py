...
def _get_fn_with_params(fn, params_tuple):
...
def lower_fun(
  ...
  def f_lowered(ctx: LoweringRuleContext, *args, **params):
    ...
    fn_bound = _get_fn_with_params(fn, params_tuple)
    in_avals_ft = FlatTree.flatten((tuple(ctx.avals_in), {}))
    debug_info = api_util.debug_info("pallas triton lower_fun", fun,
                                   args, params)
    jaxpr, _ = pe.trace_to_jaxpr(
        fn_bound, in_avals_ft, debug_info=debug_info, requires_low=True
    )
