...
from jax._src.tree_util import broadcast_prefix, tree_flatten, tree_map, tree_unflatten
    ...
    for s, d in zip(global_shape_flat, local_data_flat):
      if s is not None and s != d.shape:
        raise ValueError(
            ...
            " process, global_shape should be None or equal to local_data.shape."
            f"Got global_shape={s} and local_data.shape={d.shape}."
        )
