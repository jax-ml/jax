...
def jax_custom_jvp_call(fun, cjvp_kwargs: dict[str, Any], defjvp_kwargs: dict[str, Any],
  ...
  return bypass_repro_wrapper(cjvp_new.__call__)(cjvp_new, *fun_jvps_and_args[jvps_count:], **kwargs)
...
def jax_custom_vjp_call(fun: Callable, fwd: Callable, bwd: Callable,
  ...
  cvjp.defvjp(fwd, bwd)
  return bypass_repro_wrapper(cvjp.__call__)(cvjp, *args, **kwargs)
...
def pallas_custom_fusion_call(fun: Callable,
  ...
  return bypass_repro_wrapper(cfus.__call__)(cfus, *args, **kwargs)
