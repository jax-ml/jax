...
def _dot_product_attention_fwd(
    ...
    sliding_window_length, cudnn_version, output_checkpoint_name):
...
def _dot_product_attention_fwd_rule(
  ...
  if output_checkpoint_name:
    output = checkpoint_name(outputs[0], output_checkpoint_name)
    softmax_stat = checkpoint_name(outputs[1], output_checkpoint_name)
  else:
...
def dot_product_attention(
  ...
  Args:
    ...
    output_checkpoint_name: checkpoint name for output tensor and softmax stat
      tensor.
  Returns:
