...
def compile_or_get_cached(backend, computation_name, computation,
                          compile_options):
    ...
    if cc.is_initialized() and backend.platform == 'tpu':
        ...
        if cached_executable is not None:
            ...
            cc.put_executable(computation_name, computation, compile_options,
                              compiled, backend)
            return compiled
...
class XlaCompiledComputation:
  ...
  def from_xla_computation(
    ...
    compiled = compile_or_get_cached(backend, name, xla_computation, options)
