...
array_types: set[type] = {np.ndarray, core.WeakNdArray} | core.numpy_scalar_types  # pylint: disable=g-bare-generic
...
core.pytype_aval_mappings[core.WeakNdArray] = _make_shaped_array_for_numpy_array
...
for t in core.numpy_scalar_types:
