...
def emit_python_callback(
  ...
  if jaxlib_version <= (0, 5, 0):
    ...
    if token:
      ...
      if (
          isinstance(
              ctx.module_context.axis_context, sharding_impls.ShardingContext
          )
