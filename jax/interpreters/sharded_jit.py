  ...
  for eqn in jaxpr.eqns:
    if eqn.primitive == set_sharding_p:
      ...
      if expected_num_parts is None:
        ...
        raise ValueError(
            f"set_sharding with partitions={parts} (total partitions = "
            f"{nparts}) doesn't match expected number of partitions: "
            "{expected_num_parts}. If these partitions look right, check outer "
            " sharded_jit and/or other set_sharding calls.")
