...
class DynamicJaxprTrace(core.Trace):
  ...
  def process_primitive(self, primitive, tracers, params):
    ...
    def is_effectful(primitive, params):
      effectful = primitive.effectful
      effectful |= any(e.effectful for jaxpr in core.jaxprs_in_params(params) for e in jaxpr.eqns)
      return effectful

    eqn = new_jaxpr_eqn(invars, outvars, primitive, params, is_effectful(primitive, params), source_info)
