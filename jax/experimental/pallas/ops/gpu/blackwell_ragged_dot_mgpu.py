...
class TuningConfig:
  ...
  def __str__(self):
    return (f"tile_m={self.tile_m}_"
            f"tile_n={self.tile_n}_"
            f"tile_k={self.tile_k}_"
            f"max_concurrent_steps={self.max_concurrent_steps}_"
            f"collective={self.collective}_"
            f"grid_tile_n={self.grid_tile_n}_"
            f"epilogue_tile_n={self.epilogue_tile_n}"
            )
