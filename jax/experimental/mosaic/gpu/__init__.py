...
from jaxlib.mosaic.gpu import _mosaic_gpu_ext
...
xla_client.register_custom_call_target(
    "mosaic_gpu", _mosaic_gpu_ext._custom_call_capsule(), platform="CUDA"
)
...
def _mosaic_gpu_lowering_rule(ctx, *args, module, out_types):
  runtime_path = pathlib.Path(jaxlib.__file__).parent / 'mosaic' / 'gpu' / 'libmlir_cuda_runtime.so'
...
class LaunchContext:
  ...
  tma_descriptors: dict[tuple[ir.Value, tuple[int, ...]], ir.Value] = (
