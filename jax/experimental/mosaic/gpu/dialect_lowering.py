...
def _mgpu_mma_op_lowering_rule(
  ...
  del ctx
  in_layouts = inference_utils.in_layouts(mma_op)
  ...
  assert in_layouts[0] == expected_acc_layout
  ...
  acc = _fragmented_array_from_ir(
      mma_op.accumulator, in_layouts[0], is_signed=is_signed
  )
  a = _fragmented_array_from_ir(mma_op.a, in_layouts[1], is_signed=is_signed)
  b = _fragmented_array_from_ir(mma_op.b, in_layouts[2], is_signed=is_signed)
