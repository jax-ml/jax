...
def _async_load_store_constraint_system(
  ...
  return cs.ConstraintSystem(constraints=constraints, assignments=assignments), value_sites_for_variable
...
def _async_prefetch_constraint_system(
  ...
  del ctx
  value_sites, assignments = _vector_value_sites_and_assignments_for_async_ops(op)
  return cs.ConstraintSystem(assignments=assignments), value_sites
