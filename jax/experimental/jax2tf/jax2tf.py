...
tf_impl[lax.exp_p] = lambda x, accuracy=None: tf.math.exp(x)
tf_impl[lax_internal.exp2_p] = lambda x, accuracy=None: \
    tf.math.exp(tf.math.multiply(tf.math.log(tf.constant(2, x.dtype)), x))
tf_impl[lax.expm1_p] = lambda x, accuracy=None: tf.math.expm1(x)
tf_impl[lax.log_p] = lambda x, accuracy=None: tf.math.log(x)
tf_impl[lax.log1p_p] = lambda x, accuracy=None: tf.math.log1p(x)
tf_impl[lax.tan_p] = lambda x, accuracy=None: tf.math.tan(x)
tf_impl[lax.tanh_p] = lambda x, accuracy=None: tf.math.tanh(x)
tf_impl[lax.sin_p] = lambda x, accuracy=None: tf.math.sin(x)
tf_impl[lax.sinh_p] = tf.math.sinh
tf_impl[lax.cos_p] = lambda x, accuracy=None: tf.math.cos(x)
...
tf_impl[lax.sqrt_p] = lambda x, accuracy=None: tf.math.sqrt(x)
tf_impl[lax.square_p] = tf.math.square
tf_impl[lax.rsqrt_p] = lambda x, accuracy=None: tf.math.rsqrt(x)

def _cbrt(x, accuracy=None):
