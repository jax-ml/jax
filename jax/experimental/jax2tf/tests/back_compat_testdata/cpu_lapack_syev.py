...
""",
    ...
    f64=dict(
        ...
        expected_outputs=(
            array([
                [
                    -6.1857700048412056e-01,
                    2.4081403770912022e-01,
                    3.5662489253627483e-01,
                    -6.3034019033669797e-01,
                    1.0043483479985752e-16,
                    -2.8842036081919542e-02,
                    7.7164692943283169e-25,
                    -1.8446994643771725e-01,
                ],
                [
                    -4.7070881487314614e-01,
                    4.7473787464450845e-01,
                    -4.8036836210243367e-01,
                    4.3802686872516400e-01,
                    1.7961797619639258e-01,
                    8.3080980076741355e-03,
                    2.1415294457221756e-01,
                    -2.2856669794666584e-01,
                ],
                [
                    -3.2284062926217072e-01,
                    -5.4336490915553370e-01,
                    2.2181041859724990e-01,
                    2.9947877954402297e-01,
                    -3.6491813600134632e-01,
                    3.2867679819727436e-01,
                    3.8223299448843473e-01,
                    -2.7266344945561438e-01,
                ],
                [
                    -1.7497244365119530e-01,
                    -8.9251550609769414e-02,
                    -6.3518515114898394e-02,
                    1.9162997359209971e-01,
                    -2.2087281326110139e-01,
                    5.9957027043505064e-02,
                    -8.7632498908241274e-01,
                    -3.1676020096456303e-01,
                ],
                [
                    -2.7104258040220038e-02,
                    -3.3772873786627672e-01,
                    2.5901386593721748e-01,
                    1.7032650752287815e-01,
                    6.7521217612940332e-01,
                    -4.5036136532965476e-01,
                    -1.2279030059078447e-02,
                    -3.6085695247351163e-01,
                ],
                [
                    1.2076392757075530e-01,
                    -3.3834734096469254e-01,
                    -6.5506827461665540e-01,
                    -5.0472498521116749e-01,
                    6.9987430903492118e-02,
                    1.0595648906599275e-01,
                    8.3443844143082022e-02,
                    -4.0495370398246017e-01,
                ],
                [
                    2.6863211318173097e-01,
                    2.2958613191407318e-01,
                    6.3952843755683941e-02,
                    1.8776775771084137e-02,
                    -5.3523731432241317e-01,
                    -5.9199531677602002e-01,
                    1.7916671834524248e-01,
                    -4.4905045549140887e-01,
                ],
                [
                    4.1650029879270661e-01,
                    3.6355449432857079e-01,
                    2.9755313100756142e-01,
                    1.6826270392615944e-02,
                    1.9621068035557282e-01,
                    5.6830030587314817e-01,
                    2.9607517592514246e-02,
                    -4.9314720700035747e-01,
                ],
            ]),
            array([
                -2.4598804776133626e01,
                -4.6567755957874661e-14,
                -1.9932120610662194e-14,
                -5.7323356091157378e-15,
                -4.5459724251334835e-16,
                4.0479851042511616e-14,
                9.2325194924982089e-14,
                2.7659880477613365e02,
            ]),
        ),
        mlir_module_text="""
module @jit__lambda_ {
...
""",
        mlir_module_serialized=(
            b"ML\xefR\x03MLIRxxx-trunk\x00\x01-\x05\x01\x05\x01\x03\x05\x03\x1d\x07\t\x0b\r\x0f\x11\x13\x15\x17\x19\x1b\x1d\x1f!\x03z\x02\xf77\x01\x9b\x0f\x17\x13\x0b\x07\x0f\x0b\x0b\x0b\x0b\x17\x0b\x0b\x0b\x0b\x13\x0b\x13\x0f\x0b\x0b\x17\x0f\x13\x13\x13\x0b33\x0b\x0f\x0b\x0b\x13\x0f\x0b\x1b\x0f\x0b\x13\x0f\x0b\x0f\x0b\x0f\x0b\x0f\x0b\x13\x0b\x0f\x0b\x0f\x0b\x13\x0b\x13\x0b\x0b\x13K\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\
            b' dimension=1]\x00jit(<lambda>)/jit(main)/jit(tril)/ge\x00jit(<lambda>)/jit(main)/jit(tril)/broadcast_in_dim[shape=(8,'
            b' 8) broadcast_dimensions=()]\x00jit(<lambda>)/jit(main)/jit(tril)/select_n\x00jit(<lambda>)/jit(main)/iota[dtype=float64'
            b' shape=(64,)'
            b' dimension=0]\x00jit(<lambda>)/jit(main)/reshape[new_sizes=(8, 8)'
            b' dimensions=None]\x00permutation\x00jit(<lambda>)/jit(main)/transpose[permutation=(1,'
            b' 0)]\x00jit(<lambda>)/jit(main)/add\x00jit(<lambda>)/jit(main)/div\x00callee\x00jit(<lambda>)/jit(main)/eigh[lower=True'
            b' sort_eigenvalues=True]\x00api_version\x00backend_config\x00call_target_name\x00called_computations\x00has_side_effect\x00operand_layouts\x00output_operand_aliases\x00result_layouts\x00jax.result_info\x00tril\x00[0]\x00[1]\x00main\x00public\x00private\x00\x00lapack_dsyevd\x00'
        ),
        xla_call_module_version=4,
        function_list=[],
    ),  # End paste
...
""",
        mlir_module_serialized=(
            ...
            b' shape=(8, 8)'
            b' dimension=1]\x00jit(<lambda>)/jit(main)/jit(tril)/ge\x00jit(<lambda>)/jit(main)/jit(tril)/broadcast_in_dim[shape=(8,'
            b' 8) broadcast_dimensions=()]\x00jit(<lambda>)/jit(main)/jit(tril)/select_n\x00jit(<lambda>)/jit(main)/iota[dtype=complex64'
            b' shape=(64,)'
            b' dimension=0]\x00jit(<lambda>)/jit(main)/reshape[new_sizes=(8, 8)'
            b' dimensions=None]\x00permutation\x00jit(<lambda>)/jit(main)/transpose[permutation=(1,'
            b' 0)]\x00jit(<lambda>)/jit(main)/real\x00jit(<lambda>)/jit(main)/imag\x00jit(<lambda>)/jit(main)/neg\x00jit(<lambda>)/jit(main)/complex\x00jit(<lambda>)/jit(main)/add\x00jit(<lambda>)/jit(main)/div\x00callee\x00jit(<lambda>)/jit(main)/eigh[lower=True'
            b' sort_eigenvalues=True]\x00api_version\x00backend_config\x00call_target_name\x00called_computations\x00has_side_effect\x00operand_layouts\x00output_operand_aliases\x00result_layouts\x00jax.result_info\x00tril\x00[0]\x00[1]\x00main\x00public\x00private\x00\x00lapack_cheevd\x00'
        ),
        xla_call_module_version=4,
        function_list=[],
    ),  # End paste
    ...
    c128=dict(
        ...
        expected_outputs=(
            array([
                [
                    -6.1857700048412056e-01 + 0.0j,
                    2.4081403770912022e-01 + 0.0j,
                    3.5662489253627483e-01 + 0.0j,
                    -6.3034019033669797e-01 + 0.0j,
                    1.0043483479985752e-16 + 0.0j,
                    -2.8842036081919542e-02 + 0.0j,
                    7.7164692943283169e-25 + 0.0j,
                    -1.8446994643771725e-01 + 0.0j,
                ],
                [
                    -4.7070881487314609e-01 + 0.0j,
                    4.7473787464450828e-01 + 0.0j,
                    -4.8036836210243361e-01 + 0.0j,
                    4.3802686872516400e-01 + 0.0j,
                    1.7961797619639255e-01 + 0.0j,
                    8.3080980076741355e-03 + 0.0j,
                    2.1415294457221759e-01 + 0.0j,
                    -2.2856669794666584e-01 + 0.0j,
                ],
                [
                    -3.2284062926217072e-01 + 0.0j,
                    -5.4336490915553370e-01 + 0.0j,
                    2.2181041859724987e-01 + 0.0j,
                    2.9947877954402286e-01 + 0.0j,
                    -3.6491813600134637e-01 + 0.0j,
                    3.2867679819727436e-01 + 0.0j,
                    3.8223299448843473e-01 + 0.0j,
                    -2.7266344945561438e-01 + 0.0j,
                ],
                [
                    -1.7497244365119527e-01 + 0.0j,
                    -8.9251550609769331e-02 + 0.0j,
                    -6.3518515114898352e-02 + 0.0j,
                    1.9162997359209963e-01 + 0.0j,
                    -2.2087281326110142e-01 + 0.0j,
                    5.9957027043505008e-02 + 0.0j,
                    -8.7632498908241274e-01 + 0.0j,
                    -3.1676020096456303e-01 + 0.0j,
                ],
                [
                    -2.7104258040220017e-02 + 0.0j,
                    -3.3772873786627688e-01 + 0.0j,
                    2.5901386593721754e-01 + 0.0j,
                    1.7032650752287815e-01 + 0.0j,
                    6.7521217612940321e-01 + 0.0j,
                    -4.5036136532965476e-01 + 0.0j,
                    -1.2279030059078447e-02 + 0.0j,
                    -3.6085695247351163e-01 + 0.0j,
                ],
                [
                    1.2076392757075533e-01 + 0.0j,
                    -3.3834734096469249e-01 + 0.0j,
                    -6.5506827461665529e-01 + 0.0j,
                    -5.0472498521116760e-01 + 0.0j,
                    6.9987430903492132e-02 + 0.0j,
                    1.0595648906599270e-01 + 0.0j,
                    8.3443844143082035e-02 + 0.0j,
                    -4.0495370398246017e-01 + 0.0j,
                ],
                [
                    2.6863211318173102e-01 + 0.0j,
                    2.2958613191407312e-01 + 0.0j,
                    6.3952843755683969e-02 + 0.0j,
                    1.8776775771084192e-02 + 0.0j,
                    -5.3523731432241317e-01 + 0.0j,
                    -5.9199531677602002e-01 + 0.0j,
                    1.7916671834524250e-01 + 0.0j,
                    -4.4905045549140887e-01 + 0.0j,
                ],
                [
                    4.1650029879270667e-01 + 0.0j,
                    3.6355449432857068e-01 + 0.0j,
                    2.9755313100756148e-01 + 0.0j,
                    1.6826270392616000e-02 + 0.0j,
                    1.9621068035557282e-01 + 0.0j,
                    5.6830030587314817e-01 + 0.0j,
                    2.9607517592514260e-02 + 0.0j,
                    -4.9314720700035747e-01 + 0.0j,
                ],
            ]),
            array([
                -2.4598804776133626e01,
...
""",
        mlir_module_serialized=(
            ...
            b' shape=(8, 8)'
            b' dimension=1]\x00jit(<lambda>)/jit(main)/jit(tril)/ge\x00jit(<lambda>)/jit(main)/jit(tril)/broadcast_in_dim[shape=(8,'
            b' 8) broadcast_dimensions=()]\x00jit(<lambda>)/jit(main)/jit(tril)/select_n\x00jit(<lambda>)/jit(main)/iota[dtype=complex128'
            b' shape=(64,)'
            b' dimension=0]\x00jit(<lambda>)/jit(main)/reshape[new_sizes=(8, 8)'
            b' dimensions=None]\x00permutation\x00jit(<lambda>)/jit(main)/transpose[permutation=(1,'
            b' 0)]\x00jit(<lambda>)/jit(main)/real\x00jit(<lambda>)/jit(main)/imag\x00jit(<lambda>)/jit(main)/neg\x00jit(<lambda>)/jit(main)/complex\x00jit(<lambda>)/jit(main)/add\x00jit(<lambda>)/jit(main)/div\x00callee\x00jit(<lambda>)/jit(main)/eigh[lower=True'
            b' sort_eigenvalues=True]\x00api_version\x00backend_config\x00call_target_name\x00called_computations\x00has_side_effect\x00operand_layouts\x00output_operand_aliases\x00result_layouts\x00jax.result_info\x00tril\x00[0]\x00[1]\x00main\x00public\x00private\x00\x00lapack_zheevd\x00'
        ),
        xla_call_module_version=4,
        function_list=[],
    ),  # End paste
