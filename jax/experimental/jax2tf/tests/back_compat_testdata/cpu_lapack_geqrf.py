...
""",
    mlir_module_serialized=(
        ...
        b' 0, 0), (0, 0,'
        b' 0))]\x00jit(<lambda>)/jit(main)/householder_product\x00jax.result_info\x00triu\x00\x00[0]\x00[1]\x00main\x00public\x00private\x00lapack_sgeqrf\x00lapack_sorgqr\x00callee\x00'
    ),
...
""",
    mlir_module_serialized=(
        ...
        b' dimensions=None]\x00jit(<lambda>)/jit(main)/geqrf\x00jit(<lambda>)/jit(main)/qr[full_matrices=True]\x00edge_padding_high\x00edge_padding_low\x00interior_padding\x00jit(<lambda>)/jit(main)/pad[padding_config=((0,'
        b' 0, 0), (0, 0,'
        b' 0))]\x00jit(<lambda>)/jit(main)/householder_product\x00jax.result_info\x00triu\x00\x00[0]\x00[1]\x00main\x00public\x00private\x00lapack_dgeqrf\x00lapack_dorgqr\x00callee\x00'
    ),
    xla_call_module_version=4,
    function_list=[],
)  # End paste
...
""",
    mlir_module_serialized=(
        ...
        b' dimensions=None]\x00jit(<lambda>)/jit(main)/geqrf\x00jit(<lambda>)/jit(main)/qr[full_matrices=True]\x00edge_padding_high\x00edge_padding_low\x00interior_padding\x00jit(<lambda>)/jit(main)/pad[padding_config=((0,'
        b' 0, 0), (0, 0,'
        b' 0))]\x00jit(<lambda>)/jit(main)/householder_product\x00jax.result_info\x00triu\x00\x00[0]\x00[1]\x00main\x00public\x00private\x00lapack_cgeqrf\x00lapack_cungqr\x00callee\x00'
    ),
    xla_call_module_version=4,
    function_list=[],
)  # End paste
...
data_2023_03_17['c128'] = dict(
    ...
    expected_outputs=(
        array([
            [
                0.0 + 0.0j,
                0.9128709291752773 + 0.0j,
                0.40824829046386235 + 0.0j,
            ],
            [
...
""",
    mlir_module_serialized=(
        ...
        b' dimensions=None]\x00jit(<lambda>)/jit(main)/geqrf\x00jit(<lambda>)/jit(main)/qr[full_matrices=True]\x00edge_padding_high\x00edge_padding_low\x00interior_padding\x00jit(<lambda>)/jit(main)/pad[padding_config=((0,'
        b' 0, 0), (0, 0,'
        b' 0))]\x00jit(<lambda>)/jit(main)/householder_product\x00jax.result_info\x00triu\x00\x00[0]\x00[1]\x00main\x00public\x00private\x00lapack_zgeqrf\x00lapack_zungqr\x00callee\x00'
    ),
    xla_call_module_version=4,
    function_list=[],
)  # End paste
