...
data_2023_03_17 = dict(
    ...
    expected_outputs=(
        array(
            [
                [6.0 + 0.0j, -2.0 + 2.0j, -2.0 + 0.0j, -2.0 - 2.0j],
                [22.0 + 0.0j, -2.0 + 2.0j, -2.0 + 0.0j, -2.0 - 2.0j],
                [38.0 + 0.0j, -2.0 + 2.0j, -2.0 + 0.0j, -2.0 - 2.0j],
            ],
            dtype=complex64,
        ),
    ),
