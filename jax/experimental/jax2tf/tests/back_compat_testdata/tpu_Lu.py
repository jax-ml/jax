...
data_2023_03_21 = dict(
    ...
    expected_outputs=(
        array(
            [[6.0, 7.0, 8.0], [0.0, 1.0, 2.0], [0.5, 0.5, 0.0]], dtype=float32
        ),
