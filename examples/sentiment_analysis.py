...
def main():
    ...
    init_fn, forward_fn = stax.serial(
    ...
    _, params = init_fn(key, (-1, SEQUENCE_LEN))

    # Create the function to compute the gradients with respect a loss
    # function
    def backward_fn(params, x, y):
        preds = forward_fn(params, x)
    ...
    for epoch in range(EPOCHS):
        ...
        print('Evaluating...')
        y_test_pred = forward_fn(get_params(optim_state), x_test)
