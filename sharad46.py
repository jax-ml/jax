...
def merge(*refs):
  return merge_p.bind(*refs)

merge_p = core.Primitive('merge')
@merge_p.def_effectful_abstract_eval
def _merge_abstract_eval(ref_aval, *_):
  return ref_aval, {core.array_ref_effect}
core._ref_allocating_primitives.add(merge_p)
