...
tf_http_archive(
    ...
    sha256 = "",
    strip_prefix = "rules_ml_toolchain-30ef4a9096f9490e8f198faa5ce5bbddd1b72fdb",
    urls = tf_mirror_urls(
        "https://github.com/google-ml-infra/rules_ml_toolchain/archive/30ef4a9096f9490e8f198faa5ce5bbddd1b72fdb.tar.gz",
    ),
)
